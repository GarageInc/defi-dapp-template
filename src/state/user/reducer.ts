...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(updateUserFastFarmingMode, (state, action) => {
      state.userFastFarmingMode = action.payload.userFastFarmingMode
      state.timestamp = currentTimestamp()
    })
